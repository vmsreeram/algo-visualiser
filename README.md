...
To change the input graph (for runnig Edmond-Karp algorithm), edit the adjacency matrix C in the file Edmond_Karp.py. C[[i][j] is the capacity of edge from i to j.
